...
4. **Write the body.** Replace each `raise NotImplementedError` (or declare the table's columns). Keep every signature exactly as scaffolded — it is the contract. Add only incidental body imports. Touch nothing outside this file.
